...
const Login = () => {
   ...
   const handleResetEmail = () => {
      if (!email) {
         alert('plase input email address');
         return;
      }
      sendPasswordResetEmail(auth, email).then(() => {
         alert('Reset Eamil sent');
      });
   };
   return (
      <div className="flex justify-center mt-20">
         <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
            ...
            <form onSubmit={handleLogin} action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
               ...
               <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-end text-xs text-gray-400">
                     <button onClick={handleResetEmail} type="button" className="px-3 py-1">
                        Forgot Password?
                     </button>
                  </div>
                  <div>
            ...
            <p className="text-xs text-center sm:px-6 text-gray-400">
               ...
               <Link rel="noopener noreferrer" to="/register" className="underline text-gray-100">
                  Sign up
               </Link>
            </p>
         </div>
